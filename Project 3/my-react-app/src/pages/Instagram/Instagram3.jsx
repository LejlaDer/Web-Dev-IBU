...
const InstagramEmbed3 = () => {
  ...
  return (
    <blockquote
      ...
      data-instgrm-permalink="https://www.instagram.com/p/CuckvwSNnrb/?utm_source=ig_embed&utm_campaign=loading"
    ...
    >
      <div style={{ padding: '16px' }}>
        <a
          href="https://www.instagram.com/p/CuckvwSNnrb/?utm_source=ig_embed&utm_campaign=loading"
          style={{
            background: '#FFFFFF',
            lineHeight: '0',
            padding: '0 0',
        ...
        <p style={{ color: '#c9c8cd', fontFamily: 'Arial, sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          <a href="https://www.instagram.com/p/CuckvwSNnrb/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial, sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">A post shared by pansion / hotel za mace “GARFIELD” 😻 (@pansion.za.mace)</a>
        </p>
      </div>
    </blockquote>
  );
...
export default InstagramEmbed3;
